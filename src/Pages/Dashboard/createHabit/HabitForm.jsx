...
export default function HabitForm({ onClose }) {
  ...
  return (
    <div className="h-full flex flex-col text-white">
        ...
        <button className="px-3 py-3 border-r border-[#333333]">
        ...
        <div className="w-full flex px-3 py-3 border border-[#333333] border-t-0">
            <div className="flex gap-2 items-center">
                <TbTargetArrow color="white" size={18} />
                <h1 className="text-white">Goal</h1>
            </div>
        </div>
        <div className="w-full flex px-3 py-3 border border-[#333333] border-t-0">
            <div className="flex gap-2 items-center">
        ...
        <div className="flex items-center justify-end mt-auto px-3 py-3 gap-2 border-t border-[#333333] bg-[#242424]">
            <button className="font-medium p-2 text-sm border border-[#424242] rounded-sm cursor-pointer" onClick={onClose}>
                Cancel
            </button>
            <button disabled={true} className="font-medium p-2 text-sm rounded-sm bg-[#5487f6] disabled:bg-[#505050] text-gray-400 cursor-not-allowed">
                save
            </button>
        </div>
    </div>
